...
category="complete"			# category of the graph: 'ER' for Erdos-Reny, 'BB' for Barabasi-Albert, 'WS' for Watts-Strogatz, 'geo' for geometric or 'custom' for a custom graph 
arg1="0"			# secondary parameter for the category of graph: 'GNM' or 'GNP' for Erdos Reny, double power of preference for Barabasi, int dimension for small world, bool periodic for geometric, adjacency matrix as a string of numbers for custom
